...
std::string get_info() override{ return m_product_info.get_info() + ": " + std::to_string(m_cost_per_kg); }
...
public:
    ...
    std::string get_info() override{ return m_product_info.get_info()+ ": " +std::to_string(m_cost_per_one); }
